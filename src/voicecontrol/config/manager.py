...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "stt": {
        ...
        "whisper_model_profile": "balanced_small",
    ...
    "executor": {
        ...
        "chatgpt_launch_timeout": 15.0,
        "chatgpt_launch_poll_interval": 0.5,
        ...
        "trae_launch_poll_interval": 0.5,
        "trae_neutral_click_rel_x": 0.5,
